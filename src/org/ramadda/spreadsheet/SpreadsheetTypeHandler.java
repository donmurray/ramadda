...
public class SpreadsheetTypeHandler extends GenericTypeHandler {
    ...
    /** _more_          */
    public static final String ARG_SPREADSHEET_STOREDATA = "spreadsheet.storedata";
    ...
    public Result getHtmlDisplay(Request request, Entry entry)
        ...
        Object[] values = ((entry == null)
                           ...
                           : entry.getValues());
        String content=null;
        if(values==null || values[0] == null || values[0].toString().trim().length()==0) {
        } else {
        ...
        if(request.get(ARG_SPREADSHEET_GETXML, false)) {
            ...
            return getRepository().getHtmlOutputHandler().makeAjaxResult(request, content);
        }

        if(request.get(ARG_SPREADSHEET_GETCSV, false)) {
            if(content==null) content ="";
            Result result = new Result("", new StringBuffer(content), "text/csv");
        ...
        if(request.defined(ARG_SPREADSHEET_STOREDATA)) {
            ...
            return getRepository().getHtmlOutputHandler().makeAjaxResult(request, "ok");
    ...
    public Result getSpreadsheet(Request request, Entry entry)
        ...
        //TODO: use real path
        sb.append("<link media=\"all\" href=\"/repository/spreadsheet/styles.css\" rel=\"stylesheet\" type=\"text/css\" />\n");
        sb.append(HtmlUtil.importJS("/repository/spreadsheet/spreadsheet.js"));
        sb.append(HtmlUtil.importJS("/repository/spreadsheet/myspreadsheet.js"));
        sb.append("<div class=\"data\" id=\"data\"></div><div id=\"source\" align=\"center\">");
        ...
        sb.append(HtmlUtil.hidden(ARG_SPREADSHEET_STOREDATA,"", HtmlUtil.id(ARG_SPREADSHEET_STOREDATA))); 
        sb.append(HtmlUtil.formClose());

        StringBuffer js = new StringBuffer();
        js.append("var entryId = " + HtmlUtil.squote(entry.getId())+";\n");
        js.append(HtmlUtil.call("loadFromRamadda", HtmlUtil.squote(entry.getId())));
