...
/*
* NOTE: I (jeffmc) copied this from the IDV source tree so I can make some
* changes to support adding cookies,  etc. This needs to get checked back
* into the IDV tree
*/
...
public class HttpFormEntry {
    ...
    public void browse(JTextField fld) {
        ...
        JFileChooser chooser = new ucar.unidata.ui.FileManager.MyFileChooser(f);
    ...
    public static String[] doPost(List entries, String urlPath) {
        return doPost(entries, urlPath, null);
    }

    public static String[] doPost(List entries, String urlPath, HttpState cookies) {
