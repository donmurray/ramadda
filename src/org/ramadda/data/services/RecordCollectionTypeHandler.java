...
public abstract class RecordCollectionTypeHandler extends ExtensibleGroupTypeHandler implements RecordConstants {
    ...
    public void addMetadataToAtomXml(Entry collectionEntry, Element root)
        ...
        XmlUtil.create(
            ...
            AtomUtil.format(new Date(collectionEntry.getStartDate())), null);
        XmlUtil.create(
            doc, AtomUtil.TAG_GML_END, temporalCoverage,
            AtomUtil.format(new Date(collectionEntry.getEndDate())), null);
