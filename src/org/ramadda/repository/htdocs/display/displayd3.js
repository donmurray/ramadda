...
function getDataValue(axis,record,index){
    var data;
    if(axis.fieldIdx>=0){
...
function addColorBar(svg,colors,colorSpacing, displayWidth){
...
function RamaddaD3Display(displayManager, id, properties) {
    ...
    RamaddaUtil.defineMembers(this, {
            initDisplay: function() {
                ...
                //Note: Pass the displayWidth
                var colorBar = addColorBar(this.svg,colors,colorSpacing,displayWidth);
