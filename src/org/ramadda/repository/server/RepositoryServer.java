...
public class RepositoryServer extends HttpServer implements Constants {
    ...
    private class MyRequestHandler extends RequestHandler {
        ...
        protected void handleFileUpload(String attrName, String filename,
            ...
            OutputStream output =
                repository.getStorageManager().getFileOutputStream(f);
        ...
        protected void handleRequest(String path, Hashtable formArgs,
            ...
            try {
                ...
                Request request = new Request(repository, path, formArgs);
                request.setIp(getSocket().getInetAddress().getHostAddress());
