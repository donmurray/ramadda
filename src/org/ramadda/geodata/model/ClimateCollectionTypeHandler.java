...
@Override
    public Result getHtmlDisplay(Request request, Entry entry,
        ...
        String processButtons = 
            ...
            JQ.button("Plot Map", formId+"_do_image",js, HtmlUtils.call(formId +".makeImage","event")) + " " +
            JQ.button("Google Earth", formId+"_do_kmz",js, HtmlUtils.call(formId +".makeKMZ","event")) + " " +
            JQ.button("Time Series", formId+"_do_timeseries",js, HtmlUtils.call(formId +".makeTimeSeries","event"));
    ...
    public Result processRequest(Request request, Entry entry) throws Exception {
        ...
        if(what.equals(REQUEST_IMAGE) || what.equals(REQUEST_KMZ) || what.equals(REQUEST_TIMESERIES)) {
