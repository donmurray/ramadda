...
public class ChartApplet extends Applet {
    ...
    public void saveImage() {
        /*
            try {
              ...
              System.err.println ("gif:" + new String (bytes));
    ...
    public void init() {
        ...
        if ( !chartCanvas.forPrint) {
            //      flatCbx = new Checkbox ("Flat", flatDisplay);
            ...
            Container scrPanel = GU.doLayout(new Component[] { scrLtBtn,
                    scrEqBtn, scrRtBtn }, 4, GU.DS_N, GU.DS_N);
            ...
            top = GU.doLayout(new Component[] { floatBtn, scrPanel, label },
                              3, GU.DS_NNY, GU.DS_N);
            add("North", top);
        } else {
            add("North", label);
