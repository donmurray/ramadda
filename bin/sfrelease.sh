...
echo "copying core"
scp dist/ramaddainstaller.zip  dist/ramaddaserver.zip   dist/allplugins.jar dist/ramaddaclient.zip dist/pointtools.zip  dist/repository.war  ${sfuser},ramadda@frs.sourceforge.net:${dest}
